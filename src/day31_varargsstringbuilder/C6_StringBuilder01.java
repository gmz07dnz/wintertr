...
public class C6_StringBuilder01 {
	...
	/*
	 1) StringBuilder "mutable" 'dir. Boylece memory'de  yeni bir alan acmadan degisiklik yapilabilir.
	      Hafiza kullanimi acisindan String'den daha iyidir.
	 2) Thread-safe degildir. Syncronized degildir
	 */
	public static void main(String[] args) {
		...
		StringBuilder sb2= new StringBuilder("Mehmet"); // Ýcinde Mehmet olan bis sb uretir
		System.out.println("sb2: " + sb2);
		
		StringBuilder sb3 = new StringBuilder(10); // 10 karakter kapasitesi olan bir sb olusturur
